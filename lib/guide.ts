...
export const methods: Method[] = [
  ...
  },
  {
    ...
    headline: "This is the landscaper trick that turns 2 weeks into 8–12.",
    time: "20 minutes to band, after a trim",
    cadence: "Every 8–12 weeks while the grass is growing",
    chemicals: true,
    permanence: "season",
    effort: "low",
    bestFor: "Long sidewalks and driveways where trimming is the real chore",
    why: "Products such as Edgeless (flurprimidol + trinexapac-ethyl) are labeled for a 6-inch band along sidewalks, curbs, and driveways, including centipedegrass. They suppress gibberellic acid so stems elongate less. The grass stays, it just stops racing over the slab. Trim first, then band. Repeat through the growing season, and stop at least four weeks before dormancy.",
    steps: [
      ...
      "Band a 6-inch strip along the hardscape with a single-nozzle sprayer, following the product label for centipedegrass rates and calibration.",
      "Keep spray off beds, shrubs, and vegetable gardens. A marking dye helps you see the band and avoid drift.",
    ...
    watchouts: [
      ...
      "This is a professional-style product. If you cannot follow the label’s sprayer calibration, hire a lawn service to band it, or use the trench and wipe instead.",
    ],
    tools: [
      "Turf growth regulator labeled for edging bands (e.g. Edgeless)",
...
export const goals: {
  ...
  },
  {
    ...
    blurb: "Band a growth regulator, then a monthly wipe for stragglers.",
    recommended: ["pgr", "wipe"],
    firstMove:
      "Trim to the line you want, then band the 6-inch edge. Keep a wick bottle by the garage for the few stolons that still hop the slab in July and August.",
  },
  {
    id: "permanent",
...
export const months = [
  ...
  },
  {
    ...
    body: "After active growth returns, cut the first V-trench. First growth-regulator band only on unstressed, growing turf.",
  },
  {
    id: 5,
    name: "May",
